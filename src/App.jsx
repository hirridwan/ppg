    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
      ...
      <header className="bg-white/90 backdrop-blur-md border-b border-slate-100 fixed top-0 left-0 w-full z-50 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <h1 className="text-lg md:text-xl font-extrabold tracking-tight text-slate-900 text-center md:text-left uppercase">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 pb-8 md:pb-12 pt-32 md:pt-28 flex flex-col gap-24">
        ...
        <section id="beranda" className="scroll-mt-32">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 shadow-sm border border-slate-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-8 md:mt-12">
            {[
              { label: 'Nama Saya', value: 'Ridwan Maulana' },
              { label: 'NIM', value: '2531031' },
              { label: 'Guru Pamong', value: 'Irman Margino, S.T.' },
              { label: 'Sekolah PPL', value: 'SMAN 1 Bandung' }
            ].map((item, i) => (
              <div key={i} className="p-6 md:p-8 bg-white border border-slate-100 rounded-2xl md:rounded-[2rem] text-center shadow-sm hover:border-blue-200 hover:shadow-md transition-all">
                <h3 className="text-slate-400 font-bold text-xs uppercase mb-2 tracking-widest">{item.label}</h3>
        ...
        <section id="profil" className="scroll-mt-32">
          ...
          <div className="bg-white p-6 md:p-12 rounded-[2rem] border border-slate-100 shadow-sm">
            ...
            <blockquote className="p-6 md:p-8 border-l-4 border-blue-600 bg-slate-50 rounded-r-2xl italic text-slate-700 text-base md:text-lg font-medium leading-relaxed">
        ...
        <section id="artifak" className="scroll-mt-32">
          ...
          <div className="grid gap-8">
            {/* KARTU 1 - ARTIFAK */}
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-12 shadow-sm flex flex-col">
              <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-bold text-blue-900">1. Perangkat Pembelajaran & Dokumentasi Praktik</h3>
              </div>
              ...
              <div className="mb-8 flex-grow">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed text-justify">
                      Kendala utama yang terjadi selama proses pembelajaran berkaitan dengan kecepatan literasi informasi dan kendala teknis digital. Untuk situasi kelas yang memiliki literasi teknologi lebih rendah, perubahan difokuskan pada penambahan waktu bimbingan teknis atau modifikasi sintaks PjBL menjadi lebih sederhana.
                    </p>
                  </div>
                </div>
              </div>

              {/* ACTION BUTTONS CARD 1 */}
              <div className="border-t border-slate-100 pt-8 mt-4">
                <div className="flex flex-wrap gap-4">
                  <a href="#" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Modul Ajar (RPP) →</a>
                  <a href="#" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Media Pembelajaran →</a>
                  <a href="#" className="px-6 py-3 bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Contoh Hasil Kerja Siswa →</a>
                  <a href="#" className="px-6 py-3 bg-orange-50 text-orange-700 hover:bg-orange-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Video Praktik Mengajar →</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-12 shadow-sm flex flex-col">
              <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-bold text-blue-900">2. Penilaian Guru Pamong (GP) & DPL (L7 & L8)</h3>
              </div>
              ...
              {/* ACTION BUTTONS CARD 2 (IDENTIK DENGAN CARD 1) */}
              <div className="border-t border-slate-100 pt-8 mt-4">
                <div className="flex flex-wrap gap-4">
                  <a href="#" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Unduh Siklus 1</a>
                  <a href="#" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Unduh Siklus 2</a>
                  <a href="#" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Unduh Siklus 3</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-emerald-50 p-6 md:p-10 border border-emerald-100 rounded-[2rem] shadow-sm">
                ...
                <ul className="list-disc list-inside text-emerald-800 space-y-3 leading-relaxed text-left font-medium">
              ...
              <div className="bg-orange-50 p-6 md:p-10 border border-orange-100 rounded-[2rem] shadow-sm">
                ...
                <ul className="list-disc list-inside text-orange-800 space-y-3 leading-relaxed text-left font-medium">
            ...
            <div className="bg-white p-6 md:p-12 rounded-[2rem] border border-slate-100 shadow-sm">
              <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-6 font-black uppercase tracking-widest text-sm">Rencana Tindak Lanjut</h3>
              <p className="text-slate-600 leading-relaxed text-justify font-medium">
                Sebagai upaya pengembangan diri, saya akan menyusun Rencana Pelaksanaan Pembelajaran (RPP) yang lebih rinci dengan mempersiapkan <strong>Rencana Mitigasi (Plan B)</strong> teknis jaringan atau perangkat di kelas. Selain itu, saya berencana untuk mendalami instrumen evaluasi formatif berbasis game atau kuiz interaktif yang dapat mengukur pemahaman siswa di tengah berjalannya proyek (PjBL) tanpa mengurangi alokasi waktu yang signifikan.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-white border-t border-slate-200 mt-12 py-10">
        <div className="max-w-6xl mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <h3 className="text-lg font-bold text-slate-900 uppercase">Ridwan Maulana, S.Kom.</h3>
            <p className="text-slate-500 text-sm mt-1">Ujian Refleksi Akhir PPL Terbimbing 1</p>
          </div>
          
          <div className="flex flex-col md:flex-row items-center gap-4 text-sm font-medium">
            <a href="mailto:ridwanguru@student.upi.edu" className="flex items-center gap-2 text-slate-600 hover:text-blue-600 transition-colors bg-slate-50 px-5 py-2.5 rounded-full border border-slate-200">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
              ridwanguru@student.upi.edu
            </a>
            <a href="tel:085860565852" className="flex items-center gap-2 text-slate-600 hover:text-blue-600 transition-colors bg-slate-50 px-5 py-2.5 rounded-full border border-slate-200">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 mt-8 pt-8 border-t border-slate-100 text-center">
           <p className="text-slate-400 text-[9px] font-black uppercase tracking-[0.5em]">© 2026 Ridwan Maulana | PPG Informatika UPI</p>
        </div>
      </footer>
    </div>
  );
