...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
          ...
          <div className="grid gap-6 md:gap-8">
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-12 shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 border-b border-slate-100 pb-6">
                <h3 className="text-xl md:text-2xl font-bold text-blue-900">1. Modul Ajar & Rencana Pembelajaran</h3>
                <a href="https://drive.google.com/drive/folders/dummy-link-rpp" target="_blank" rel="noreferrer" className="mt-4 md:mt-0 inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition font-bold text-sm">
                  Lihat Dokumen →
                </a>
              </div>
              
              <div className="mb-8">
                <h4 className="font-bold text-slate-800 mb-2">Konteks & Teori Pedagogi</h4>
            ...
            {/* Card 2 */}
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-12 shadow-sm">
              <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-4 border-b border-slate-100 pb-6">2. Hasil Penilaian Guru Pamong (L7 & L8)</h3>
      ...
      {/* FOOTER REVISI - Lebih bersih & terang */}
