        ...
        <section id="beranda" className="scroll-mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12">
            ...
            <div className="p-6 md:p-8 bg-white border border-slate-100 rounded-2xl md:rounded-[2rem] text-center shadow-sm hover:border-blue-200 hover:shadow-md transition-all">
              ...
              <h3 className="text-slate-400 font-bold text-xs uppercase mb-2 tracking-widest">Dosen Pembimbing Lapangan</h3>
            ...
            <div className="p-6 md:p-8 bg-white border border-slate-100 rounded-2xl md:rounded-[2rem] text-center shadow-sm hover:border-blue-200 hover:shadow-md transition-all">
              ...
              <h3 className="text-slate-400 font-bold text-xs uppercase mb-2 tracking-widest">LPTK</h3>
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-12 shadow-sm">
              <div className="flex flex-col mb-8 border-b border-slate-100 pb-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <a href="https://drive.google.com/drive/folders/dummy-link-rpp" target="_blank" rel="noreferrer" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Modul Ajar (RPP) →</a>
                  <a href="https://drive.google.com/drive/folders/dummy-link-media" target="_blank" rel="noreferrer" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Media Pembelajaran →</a>
                  <a href="https://drive.google.com/drive/folders/dummy-link-hasil" target="_blank" rel="noreferrer" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Contoh Hasil Kerja Siswa →</a>
                  <a href="https://youtube.com/dummy-link-video" target="_blank" rel="noreferrer" className="px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white rounded-xl font-bold text-sm text-center transition-colors">Video Praktik Mengajar →</a>
                </div>
              </div>
