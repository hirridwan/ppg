          ...
          <div className="mb-14">
            ...
            <div className="grid md:grid-cols-2 gap-8 pl-0 md:pl-12">
              ...
              <div className="bg-[#fafafa] dark:bg-slate-800/50 p-8 rounded-3xl border border-slate-100 dark:border-slate-700">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-justify">
                  Secara pedagogik, saya ingin menjadi guru yang terus berinovasi dalam menciptakan metode dan media pembelajaran masa depan yang semakin berpusat pada peserta didik, sehingga setiap anak dengan gaya belajar yang berbeda tetap bisa mencapai potensi maksimalnya tanpa merasa tertinggal.[cite: 8]
                </p>
              </div>
              <div className="bg-[#fafafa] dark:bg-slate-800/50 p-8 rounded-3xl border border-slate-100 dark:border-slate-700">
                <h4 className="font-bold text-[#1A1A1A] dark:text-white mb-4 flex items-center gap-2">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-justify">
                  Secara kepribadian, saya ingin menjadi guru yang kematangan emosional dan kebijaksanaannya semakin terasah seiring berjalannya waktu, sehingga aura positif dan ketenangan saya dapat terus menular kepada siswa dan memberikan rasa aman bagi mereka di sekolah.[cite: 8]
                </p>
              </div>
              <div className="bg-[#fafafa] dark:bg-slate-800/50 p-8 rounded-3xl border border-slate-100 dark:border-slate-700">
                <h4 className="font-bold text-[#1A1A1A] dark:text-white mb-4 flex items-center gap-2">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-justify">
                  Secara sosial, saya ingin menjadi guru yang kehadirannya selalu dirindukan oleh siswa dan diandalkan oleh rekan sejawat, serta mampu membangun kolaborasi yang semakin kuat dengan orang tua dan masyarakat demi kemajuan pendidikan anak-anak.[cite: 8]
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-[#fafafa] dark:bg-slate-800/50 p-10 rounded-3xl border border-slate-100 dark:border-slate-700 ml-0 md:ml-12">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-justify text-lg">
                Saya ingin memiliki guru yang tidak membeda-bedakan saya dengan teman-teman yang lain. Guru yang asyik, bisa diajak bercanda saat santai, tetapi tetap bisa membimbing saya dengan serius saat sedang belajar. Saya sangat mengharapkan guru yang sabar, tidak mudah marah atau berkata kasar ketika kelas sedang tidak kondusif, dan mau mendengarkan pendapat saya sampai selesai tanpa memotong pembicaraan. Selain itu, saya ingin diajar oleh guru yang selalu menghargai keberanian saya saat mencoba menjawab, serta memberikan nilai yang adil dan benar-benar sesuai dengan usaha serta kemampuan saya.[cite: 8]
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#8234E6] to-[#6c28c4] rounded-[3rem] p-10 md:p-16 shadow-2xl relative overflow-hidden text-white">
          ...
          <div className="grid gap-10 relative z-10">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 md:p-10 rounded-3xl border border-white/20">
              ...
              <p className="text-purple-50 mb-6 text-lg">Berikut adalah langkah-langkah konkret yang akan saya lakukan untuk mencapai visi:[cite: 8]</p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-50 leading-relaxed text-justify">
                      Membangun wibawa melalui tindakan konkret, seperti datang tepat waktu, berpenampilan rapi, dan selalu menjaga kestabilan emosi tanpa menggunakan kata-kata kasar saat menghadapi keributan di kelas. Saya juga memastikan seluruh proses penilaian dilakukan secara objektif dan transparan.[cite: 8]
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-50 leading-relaxed text-justify">
                      Memperlakukan semua siswa secara setara. Saya akan memosisikan diri sebagai pendengar yang saksama dan empatik bagi keluhan maupun pendapat siswa, serta aktif membangun kolaborasi yang positif dengan rekan sejawat lintas generasi untuk kemajuan sekolah.[cite: 8]
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-50 leading-relaxed text-justify">
                      Rutin mengikuti pelatihan, seminar, dan lokakarya untuk terus memperbarui ilmu pedagogik dan penguasaan teknologi Informatika. Saya juga akan konsisten melakukan refleksi pembelajaran secara berkala dengan meminta masukan langsung dari siswa, guru, dan orang tua guna mengevaluasi kecepatan dan efektivitas penyampaian materi saya.[cite: 8]
                    </p>
                  </div>
                </div>
              </div>
